...
public class SaveInflationReferanceDataRequest {
    ...
    @ApiModelProperty("Inflation Direction Parameter ") private int inflationdirectionparm ;
    ...
    public int getInflationdirectionparm() {
        return inflationdirectionparm;
    }

    public void setInflationdirectionparm(int inflationdirectionparm) {
