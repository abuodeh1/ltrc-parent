...
public class SaveApplicationBusRentingCompanyeLicenseDataRequest {

    @ApiModelProperty("Application Bus Rental Office License ID Parameter ") private long applicationbusrentalofficelicenseidparm ;
    ...
    @ApiModelProperty("Sub Class Parameter ") private long subclassparm ;
    @ApiModelProperty("Issue Status Parameter ") private int issuestatusparm ;
    ...
    public long getSubclassparm() {
        return subclassparm;
    }

    public void setSubclassparm(long subclassparm) {
        this.subclassparm = subclassparm;
    }

    public int getIssuestatusparm() {
        return issuestatusparm;
    }

    public void setIssuestatusparm(int issuestatusparm) {
        this.issuestatusparm = issuestatusparm;
    }
}
